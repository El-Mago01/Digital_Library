...
class Author(db.Model):
    """
    Author model describing the characteristics of an author. Class is used for
    ORM
    """
    ...
    # This is a reference key from open library
    olid_author = db.Column(db.String)
    ...
    def __repr__(self):
        logging.info(
            f"Author: {
                self.name} author_id: {
                self.author_id} birth_year: {
                self.birth_year} death_year: {
                    self.death_year}")
        return f"Author: {
            self.name} author_id: {
            self.author_id} birth_year: {
...
class Book(db.Model):
    """
    Book model describing the characteristics of a book. Class is used for
    ORM
    """
    ...
    def serialize(self):
        """
        Serializes this object, e.g. so that it can be stored as JSON
        :return:
        """
        self_dict = {}
    ...
    def __repr__(self):
        """
        Ensure the objected can be printed as string
        :return:
        """
        logging.info(
            f"Book title: {
                self.title} author_id: {
                self.author_id} publication_year: {
